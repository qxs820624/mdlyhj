...
public class RSSParser {
	 ...
	 * @throws RSSException
	 */
	public void setXmlResource(byte[] data) throws RSSException {
		try {
	 ...
	 * @throws RSSException
	 */
	public void setXmlResource(InputStream is) throws RSSException {
		try {
			in = is;
	 ...
	 * @throws RSSException
	 */
	public static void parseXml(byte[] data, DefaultHandler handler,
			boolean validating) throws RSSException {
		try {
			RSSParser p = new RSSParser();
			p.setXmlResource(data);
			p.setHandler(handler);
			p.setValidate(validating);
			p.parse();
