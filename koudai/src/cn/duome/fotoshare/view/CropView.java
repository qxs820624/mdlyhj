...
public class CropView extends ImageView {
	...
	public void init(){
		...
		leftAreaPaint.setAlpha(CropView.LEFT_AREA_ALPHA);
	}
	...
	private boolean isOutOfArea(int x,int y){
		switch(recFlag){
		case CropView.PRESS_LB:
			this.pressLB(x - mx, y - my);
			break;
		case CropView.PRESS_LT:
			this.pressLT(x - mx, y - my);
			break;
		case CropView.PRESS_RB:
			this.pressRB(x - mx, y - my);
			break;
		case CropView.PRESS_RT:
	...
	public boolean findPresseddst(int x,int y){
		...
		if(this.isInRect(x, y, recLB)){
			recFlag = CropView.PRESS_LB;
			returnFlag = true;
		}else if(this.isInRect(x, y, recLT)){
			recFlag = CropView.PRESS_LT;
			returnFlag = true;
		}else if(this.isInRect(x, y, recRB)){
			recFlag = CropView.PRESS_RB;
			returnFlag = true;
		}else if(this.isInRect(x, y, recRT)){
			recFlag = CropView.PRESS_RT;
			returnFlag = true;
		}
