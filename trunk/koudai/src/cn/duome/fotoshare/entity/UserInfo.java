...
public class UserInfo {
	...
	//
	private final static String ZOOM = "ZOOM_LEVEL";
	//
	private final static String INHIBITORY = "INHIBITORY";
	//
	...
	public UserInfo(Context context) {
		...
		setAutoHide(settings.getBoolean(AUTOHIDE, true));
		...
		setPortrait(settings.getBoolean(PORTRAIT, true));
		setDefaultFolder(settings.getString(FOLDER, null));
		setSaveDays(settings.getInt(SAVEDAYS, defaultSaveDays));
		setZoom(settings.getFloat(ZOOM, -1.0f));
		setInhibitory(settings.getBoolean(INHIBITORY, false));
	...
	public void saveData() {
		...
		settings.edit().putBoolean(AUTOLOGIN, isAutoLogin())
				...
				.putString(STARTURL, getStartUrl())
				...
				.putFloat(ZOOM, this.getZoom())
				.putBoolean(INHIBITORY, this.isInhibitory())
