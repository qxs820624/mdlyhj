...
public class Kaixin {
	 ...
	 */
	public static final String API_KEY = "288738149970b85e5d6367b89428cc6c"; // 替换为申请时获得的api
																				// key

	/**
	 * 组件申请时获得的secret key
	 */
	public static final String SECRET_KEY = "eed115bf5c16f050a7f606bfa2dd8f6c"; // 替换为申请时获得的secret
																				// key

	/**
	 * 组件申请时填写的网站地址
	 */
	private static String KX_AUTHORIZE_CALLBACK_URL = "http://3gqa.com/item_down.php?pid=29&id=5904"; // 替换为申请组件时填写的网站地址
	...
	private void authorize(final Context context, String[] permissions,
		...
		if (context.checkCallingOrSelfPermission(Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
			...
			dialog = new KaixinDialog(context, url, new KaixinDialogListener() {
				@Override
