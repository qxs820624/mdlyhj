...
import com.example.uitl.MusicUtil;
...
public class Player implements OnBufferingUpdateListener, OnCompletionListener,
	...
	public Player(String videoUrl, final SeekBar skbProgress, TextView cTv,
			TextView dTv) {
	...
	Handler handleProgress = new Handler() {
		public void handleMessage(Message msg) {
			...
			if (duration > 0) {
				...
				currentTv.setText(MusicUtil.formatTime(mediaPlayer
						.getCurrentPosition()));
				durationTv.setText(MusicUtil.formatTime(mediaPlayer
						.getDuration()));
			}
		};
	};
