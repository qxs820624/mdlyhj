...
public class RSSHandler extends DefaultHandler {
	...
	public static final String ITEM_FAVLINK_TAG = "favlink"; // TODO
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (tagIsEqual(currenttag, SEQ_TAG)) {
			reading_seq = true;
			seq = new RSSSequence();
		}
		...
		if (tagIsEqual(currenttag, SEQ_ELEMENT_TAG))
			processSeqElement(attributes);

		if (currenttag.toUpperCase().startsWith("SY:"))
	...
	private void processItem(String qName, String data) {
		...
		if (tagIsEqual(qName, ITEM_FAVLINK_TAG))
			itm.setFavLink(data);
